    ...
    public partial class UUnitTestSubsystem
    {
        ...
        private void TestArrayFindLast()
        {
            ...
            
            {
                ...
                TestCoreSubsystem.TestEqual("ArrayCompoundFindLastFalse", Array.FindLast(GetWorld()), TArray.INDEX_NONE);
            }
        }
        ...
        private void TestArraySwapMemory()
        {
            ...
            
            {
                ...
                TestCoreSubsystem.TestEqual("ArrayCompoundSwapMemory", Array[0] == TestCoreSubsystem && Array[1] == this, true);
            }
        }
        ...
        private void TestArraySwap()
        {
            ...
            
            {
                ...
                TestCoreSubsystem.TestEqual("ArrayCompoundSwap", Array[0] == TestCoreSubsystem && Array[1] == this, true);
            }
        }
    }
}